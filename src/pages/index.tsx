  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Dawood: Elevating Your Ecommerce Experience. A powerful SaaS app designed with Nuxt and Laravel, offering seamless online selling solutions."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Dawood: Elevating Your Ecommerce Experience. A powerful SaaS app designed with Nuxt and Laravel, offering seamless online selling solutions.`}
            </Text>
            <Box
